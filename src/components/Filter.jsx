import AutoSlider from "./AutoSlider"; // تعديل الاستيراد
      ...
      <div className="px-4 mx-auto text-center pt-24 lg:pt-32">
        ...
        <div className="flex justify-center">
          <ul className="flex flex-col sm:flex-row rounded-xl sm:rounded-full justify-center align-middle gap-3 text-sm bg-gray-200 p-2">
            <li className="px-4 py-2 rounded-full cursor-pointer select-none hover:bg-gray-900 text-gray-900 hover:text-white">
              Bestselling Audiobooks
            </li>
            <li className="px-4 py-2 rounded-full cursor-pointer select-none bg-gray-900 text-white">
              New & Trending Ebooks
            </li>
            <li className="px-4 py-2 rounded-full cursor-pointer select-none hover:bg-gray-900 hover:text-white text-gray-900">
              Fan-Favorite Audiobooks
            </li>
          </ul>
        </div>
        {/* Uncomment AutoSlider usage if needed */}
